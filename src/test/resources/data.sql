...
INSERT INTO medical_worker(end_hr, phone, rating, start_hr, tip, clinic_id, user_id) VALUES (17, 062457893, 8, 9, 'DERMATOLOSKI', 2, 7);
...
INSERT INTO room(first_free_date, is_free, room_name, room_number, tip_room, clinic_id, version) VALUES ('2019-12-15', true, 'Dijagnostika', 215, 'PREGLED', 1, 0);
...
INSERT INTO checkup(date_of_checkup, discount, duration, price, scheduled, time_of_checkup, tip, check_up_type_id, clinic_id, patient_id, room_id, pending, finished, is_rated_doctor, is_rated_clinic, version) VALUES ('2020-02-02', 0, 1, 25, false, '15', 'PREGLED', 1, 1, 1, 1, false, false, false, false, 1);
INSERT INTO checkup(date_of_checkup, discount, duration, price, scheduled, time_of_checkup, tip, check_up_type_id, clinic_id, patient_id, room_id, pending, finished, is_rated_doctor, is_rated_clinic, version) VALUES ('2020-01-23', 0, 1, 76, true, '16', 'PREGLED', 1, 1, 1, 1, false, false, false, false, 1);
